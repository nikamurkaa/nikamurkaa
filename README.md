...
Другие репозитории: [WebSec Users API](https://github.com/nikamurkaa/websec-users-api) · [WebSec SQL Injection](https://github.com/nikamurkaa/websec-sql-injection) · [Async YaCut](https://github.com/nikamurkaa/async-yacut) · [Integration Testing](https://github.com/nikamurkaa/eshoponweb-integration-testing) · [Networking Basics](https://github.com/nikamurkaa/networking-basics-lab)

### Технологии

**Backend:** Python, Django REST Framework, FastAPI, Flask, Node.js, Express  
**Data:** PostgreSQL, MySQL, SQLite, SQLAlchemy, Alembic  
**Security:** authentication & authorization, access control, API Security, SCA/SBOM, SQL Injection  
...
Other repositories: [WebSec Users API](https://github.com/nikamurkaa/websec-users-api) · [WebSec SQL Injection](https://github.com/nikamurkaa/websec-sql-injection) · [Async YaCut](https://github.com/nikamurkaa/async-yacut) · [Integration Testing](https://github.com/nikamurkaa/eshoponweb-integration-testing) · [Networking Basics](https://github.com/nikamurkaa/networking-basics-lab)
